<?php
/**
 * RoomControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Room Module
 *
 * @category Test
 * @package Room
...
namespace OnePlaceTest\Room\Controller;

use OnePlace\Room\Controller\RoomController;
...
class RoomControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/room', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('room');
        $this->assertControllerName(RoomController::class); // as specified in router's controller name alias
        $this->assertControllerClass('RoomController');
        $this->assertMatchedRouteName('room');
    }
