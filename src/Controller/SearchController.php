<?php
/**
 * SearchController.php - Room Search Controller
 *
 * Main Controller for Room Search
 *
 * @category Controller
 * @package Room
...
class SearchController extends CoreSearchController
{
    ...
    /**
     * Dump Room data to desired format
     *
     * @return bool
     * @since 1.0.0
     */
    public function indexAction() {
         ...
         * Hooks available:
         *
         * room-search-before (before show search form)
         * room-search-before-execute (before query)
         * room-search-after-execute (after query - before show results)
         */
        return $this->generateSearchView('room');
    }
}